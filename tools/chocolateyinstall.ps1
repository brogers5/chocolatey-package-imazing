...
$packageArgs = @{
    ...
    fileType       = 'EXE'
    url            = 'https://downloads.imazing.com/windows/iMazing/3.4.0.10/iMazing_3.4.0.10.exe'
    softwareName   = $softwareNamePattern
    checksum       = '6ba03367e7ef0056192b5627355a9c3751e68f46a5e163bc5b4ba6f343f45bcb'
    checksumType   = 'sha256'
    validExitCodes = @(0)
